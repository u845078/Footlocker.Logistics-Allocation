...
namespace Footlocker.Logistics.Allocation.Models.Services
{
    public class ExistingPODAO
    {
        ...
        public List<ExistingPO> GetExistingPO(string div, string PO)
        {
            ...
            SQL += " and b.RETL_OPER_DIV_CODE = c.RETL_OPER_DIV_CODE and b.stk_dept_num = c.stk_dept_num and b.stk_num = c.stk_num";
        ...
        public List<ExistingPO> GetExistingPOsForSku(string div, string sku, bool openOnly)
        {
            ...
            SQL += " and b.RETL_OPER_DIV_CODE = c.RETL_OPER_DIV_CODE and b.stk_dept_num = c.stk_dept_num and b.stk_num = c.stk_num";
            SQL += " and b.RETL_OPER_DIV_CODE = d.RETL_OPER_DIV_CODE and b.stk_dept_num = d.stk_dept_num and b.stk_num = d.stk_num";
            ...
            SQL += " and e.CASELOT_NUM = d.CASELOT_NUMBER";
            SQL += " and e.RETL_OPER_DIV_CODE = d.RETL_OPER_DIV_CODE";
            SQL += " group by d.WHSE_ID_NUM, a.PO_NUM, a.EXPECTED_DELV_DATE, b.RETL_OPER_DIV_CODE, ";
            SQL += " b.stk_dept_num, b.stk_num, b.WDTH_COLOR_NUM, b.TOT_WC_RETL_AMT, c.GENL_STK_DESC,";
            SQL += " a.po_status_code, a.vend_num, a.crte_date";
