...
namespace Footlocker.Logistics.Allocation.Controllers
{
    ...
    public class StoreExtensionController : AppController
    {
        ...
        public ActionResult BatchUpdate(long ruleSetID = -1, bool isRestrictingToUnassignedCustomer = false)
        {
            ...
            { 
                RuleSetID = ruleSetID, 
                IsRestrictingToUnassignedCustomer = isRestrictingToUnassignedCustomer 
            };
        ...
        public ActionResult _Update()
        {
            ...
            Stores = (from a in Stores join b in currentUser.GetUserDivisions() on a.Division equals b.DivCode select a).ToList();
